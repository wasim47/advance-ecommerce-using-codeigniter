...
<script>
function clear_cart() {
	var result = confirm('Are you sure want to clear all productings?');
...
<div style="margin:0px auto; width:600px;" >
	...
	<table border="0" cellpadding="5px" cellspacing="1px" style="font-family:Verdana, Geneva, sans-serif; font-size:11px; background-color:#E1E1E1" width="100%">
		...
		<tr>
			...
			<td colspan="5" align="right"><input type="button" value="Clear Cart" onclick="clear_cart()" class="gred_bar">
