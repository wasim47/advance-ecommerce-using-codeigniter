...
<div class="container">
  ...
  <div class="row">
        ...
        <div class="row bestseller-grid product-grid">
          <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 product-grid-item">
            <div class="product-thumb transition">
              <div class="image product-imageblock"> <a href="#"> <img src="<?php echo base_url();?>assets/images/product/2product50x59.jpg" alt="women's New Wine is an alcoholic" title="women's New Wine is an alcoholic" class="img-responsive" /> </a>
    ...
    <div class="col-sm-9" id="content">
      	...
      	<h1>Shopping Cart &nbsp;(<?php echo count($cart);?> Items) </h1>
	...
	?>
              <tr>
                <td class="text-center"><a href="<?php echo base_url();?>index/product_details/<?php echo $product_id;?>"><img src="<?php echo base_url()?>uploads/images/product/main_img/<?php echo $main_image;?>" alt="<?php echo $item['name'];?>" style="width:80px; height:auto"></a></td>
                <td class="text-left"><a href="<?php echo base_url();?>index/product_details/<?php echo $product_id;?>"><?php echo $item['name'];?></a></td>
                <td class="text-left"><?php echo $pro_code;?></td>
                
                <td class="text-right"><?php echo 'BDT '.$item['price'].' Tk';?></td>
                <td class="text-left"><div style="max-width: 200px;" class="input-group btn-block">
                    ...
                    onclick="<?php echo base_url('cart/remove/'.$item['rowid']); ?>"><i class="fa fa-times-circle"></i></button>
                    </span></div></td>
                <td class="text-right"><?php echo 'BDT '.$item['subtotal'].' TK';?></td>
              </tr>
        ...
        <input type="hidden" value="<?php echo $pro_array;?>" name="productId" />          
	            ...
	            <tfoot>
                    <tr>
                        <td colspan="4" align="right">Total products (tax incl.)</td>
                        <td colspan="2" align="right"><?php echo number_format($grand_total,2); ?></td>
                    </tr>
                    <tr>
                        <td colspan="4" align="right"><strong>Shipping Cost</strong></td>
                        <td colspan="2" align="right"><strong><?php echo $total_shipment;?></strong></td>
                    </tr>
                     <tr>
      ...
      <div class="buttons">
        <div class="pull-left"><a class="btn btn-default" href="index-2.html">Continue Shopping</a></div>
