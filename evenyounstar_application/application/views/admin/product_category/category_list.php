                              ...
                              <div class="x_content">
                                ...
                                <div class="container">
                                  <table class="table table-striped" width="100%"> 
									...
									$boutiqueshop=$categoryData->boutiqueshop;
									
									$butikque=$this->Index_model->getAllItemTable('boutiqueshop','user_id',$boutiqueshop,'','','user_id','desc');
									if($butikque->num_rows() > 0){
										foreach($butikque->result() as $butikrow);
										$shopName=$butikrow->username;
									}
									else{
										$shopName=$boutiqueshop;
										}
