                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <?php echo form_open('', 'name="formUserSearch" id="form_check"');?>
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Total Boutique (<?php echo $boutiqueshoplist->num_rows();?>)</h2>
                                ...
                                <div class="container">
                                  <table class="table table-striped" width="100%">
                                    ...
                                    <?php
									$i=0;
                                   foreach($boutiqueshoplist->result() as $boutiqueshop):
										...
										$editorName=$boutiqueshop->editorName;
										$status=$boutiqueshop->active;
									$i++;
									?>
                                      <tr>
                                        <td><?php echo $i;?></td>
                                        <td>
                                        <input type="checkbox"  name="summe_code[]" id="summe_code<?php echo $i; ?>" value="<?php echo $boutiqueshop_id;?>" /></td>
                                        <td><?php echo $boutiqueshop_name; ?></td>
                                        ...
                                        <td width="9%" align="left">
                                         ...
                                         <td> 
                                         	<a href="<?php echo base_url('ouradminmanage/boutique_registration/'.$boutiqueshop_id);?>" class="btn btn-default btn-sm">
          										<span class="glyphicon glyphicon-edit"></span> Edit
                                            </a> 
                                            <a href="javascript:void();" onclick="openPage1('<?php echo $boutiqueshop_id;?>','boutiqueshop','user_id');" class="btn btn-default btn-sm">
