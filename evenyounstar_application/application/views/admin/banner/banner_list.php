...
function approve(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>ouradminmanage/approve?approve_val="+data+"&&tablename=banner&&id=b_id&&status=status";
...
function deapprove(){
	...
	if(data=="")
	{
		...
		return false;
			...
			var hrefdata ="<?php echo base_url();?>ouradminmanage/deapprove?deapprove_val="+data+"&&tablename=banner&&id=b_id&&status=status";
			window.location.href=hrefdata;
	}
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_title">
                                    ...
                                    <a href="<?php echo base_url('ouradminmanage/banner_registration');?>" class="btn btn-primary">New Banner</a>
                                  ...
                                  <table class="table table-striped">
									...
									?>
                                      <tr>
                                        <td><?php echo $i;?></td>
                                         <td>
                                        <input type="checkbox"  name="summe_code[]" id="summe_code<?php echo $i; ?>" value="<?php echo $b_id;?>" /></td>
